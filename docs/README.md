...
- [ ] 회원의 이름은 4글자 이상, 10글자 이하여야 한다.
- [ ] 회원의 비밀번호는 4글자 이상, 10글자 이하여야 한다.

### 상품

- [ ] 상품의 이름은 1글자 이상, 20글자 이하여야 한다.
- [ ] 상품의 가격은 1 ~ 10,000,000원 이여야 한다.

### 장바구니

- [ ] 하나의 상품을 1 ~ 1,000개 까지 담을 수 있다.

### 쿠폰

- [ ] 쿠폰의 이름은 1글자 이상, 50글자 이하여야 한다.
- [ ] 쿠폰의 할인율은 5 ~ 90%여야 한다.
