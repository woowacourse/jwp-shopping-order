...
public class CartItemDao {
    ...
    public void deleteByIdsAndMemberId(Long id, List<Long> cartItemIds) {
    ...
    public List<CartItemEntity> findAllByIdsAndMemberId(Long memberId, List<Long> cartProductIds) {
