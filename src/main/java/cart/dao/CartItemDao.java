...
public class CartItemDao {
    ...
    public List<CartItem> findByMemberId(Long memberId) {
        String sql =
                "SELECT cart_item.id, cart_item.member_id, member.email, member.password, product.id, product.name, product.price, product.image_url, cart_item.quantity "
                        +
                        "FROM cart_item " +
        ...
        return jdbcTemplate.query(sql, new Object[]{memberId}, (rs, rowNum) -> {
            ...
            Member member = new Member(memberId, new Email(email), new Password(password));
    ...
    public Long save(CartItem cartItem) {
        ...
        jdbcTemplate.update(connection -> {
            ...
            ps.setInt(3, cartItem.getQuantity().quantity());
    ...
    public void updateQuantity(CartItem cartItem) {
        ...
        jdbcTemplate.update(sql, cartItem.getQuantity().quantity(), cartItem.getId());
    }
}
