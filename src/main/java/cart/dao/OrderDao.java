...
public class OrderDao {
    ...
    public List<OrderResultMap> findByMemberId(final Long memberId) {
        final String sql = "SELECT o.id orderId, o.price orderPrice, o.date date, oi.id orderItemId, oi.quantity quantity, p.id productId, p.price price, p.name name, p.image_url imageUrl " +
                "FROM order_item oi " +
