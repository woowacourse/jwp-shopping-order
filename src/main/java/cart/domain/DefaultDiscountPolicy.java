...
public class DefaultDiscountPolicy implements DiscountPolicy {
    ...
    public DefaultDiscountPolicy(final long id, final String name, final Money threshold,
    ...
    public DefaultDiscountPolicy(final String name, final Money threshold,
        final double discountRate) {
        this.id = null;
        this.name = name;
        this.threshold = threshold;
