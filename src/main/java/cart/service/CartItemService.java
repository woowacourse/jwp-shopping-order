...
public class CartItemService {
    ...
    public Long addCart(MemberInfo member, CartItemRequest cartItemRequest) {
    ...
    public List<CartItemResponse> findAllByMember(MemberInfo member) {
    ...
    public void modifyQuantity(MemberInfo member, Long id, CartItemQuantityUpdateRequest request) {
    ...
    public void remove(MemberInfo member, Long id) {
        CartItem cartItem = cartItemRepository.findById(id)
                .orElseThrow(() -> new CartItemException(ExceptionType.NOT_FOUND_CART_ITEM));
        cartItem.checkOwner(member);
