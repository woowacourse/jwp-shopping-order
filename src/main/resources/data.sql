...
INSERT INTO product (id, name, price, image_url , isOnSale, policy_id) VALUES (3, '피자', 13000, 'https://images.unsplash.com/photo-1595854341625-f33ee10dbf94?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80', false, 3);
INSERT INTO product (id, name, price, image_url , isOnSale, policy_id) VALUES (4, '보쌈', 20000, 'https://images.unsplash.com/photo-1595854341625-f33ee10dbf94?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80', false, 4);
...
INSERT INTO cart_item (id, cart_id, product_id, quantity) VALUES (1, 1, 1, 2);
INSERT INTO cart_item (id, cart_id, product_id, quantity) VALUES (2, 1, 2, 4);
INSERT INTO cart_item (id, cart_id, product_id, quantity) VALUES (3, 1, 3, 5);
