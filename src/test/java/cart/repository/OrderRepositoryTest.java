...
class OrderRepositoryTest {
    ...
    void save() {
        ...
        orderRepository.save(new Order(List.of(
                new OrderItem(new Product(1L, "상품명", Money.from(1000), "imgUrl"), Quantity.from(1)))),
    ...
    void findById_idNotFound_fail() {
        // given
        given(orderDao.findById(anyLong())).willThrow(
            new IllegalOrderException("존재하지 않는 주문 id 입니다."));
