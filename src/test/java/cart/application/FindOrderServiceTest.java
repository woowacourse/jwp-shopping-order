...
class FindOrderServiceTest {
    ...
    //         // given
    //         Point currentPoint = new Point(1L, member1, 1000);
    ...
    //
    //         // when & then
    //         assertThatThrownBy(() -> findOrderService.addOrder(member1, request))
    ...
    //         Point currentPoint = new Point(1L, member1, 0);
    ...
    //         Point currentPoint = new Point(1L, member1, pointOwned);
    ...
    //
    //         assertDoesNotThrow(() -> findOrderService.addOrder(member1, request));
    //     }
    // }
    //
    // @Nested
    ...
    //
    //         // when & then
    //         assertThatThrownBy(() -> findOrderService.cancelOrder(member1, 1L))
    //             .isInstanceOf(IllegalOrderException.class)
    ...
    //             Collections.emptyList());
    //         Point originalPoint = new Point(1L, member1, 0);
    //         given(orderDao.findById(anyLong())).willReturn(orderByMember1);
    //         given(pointDao.findByMemberId(anyLong())).willReturn(originalPoint);
    //
    //         // when & then
    //         assertDoesNotThrow(() -> findOrderService.cancelOrder(member1, 1L));
    //     }
    // }
}
