...
class OrderApiControllerTest {
    ...
    void createOrder() throws Exception {
        ...
        mockMvc.perform(post("/orders")
                ...
                .andExpect(jsonPath("$.createdAt", is("2023-05-31 10:00:00.0")))
    ...
    void getOrders() throws Exception {
        ...
        mockMvc.perform(get("/orders"))
                ...
                .andExpect(jsonPath("$[0].createdAt", is("2023-05-31 10:00:00.0")))
                ...
                .andExpect(jsonPath("$[1].createdAt", is("2022-05-31 10:00:00.0")))
