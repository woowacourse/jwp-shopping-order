...
class ProductTest {
    ...
    void 상품_이름이_없으면_예외를_발생한다() {
        assertThatThrownBy(
                () -> new Product(null, null, new ImageUrl("www.test.com"), new Price(BigDecimal.valueOf(1000))))
    ...
    void 상품_이미지가_없으면_예외를_발생한다() {
        assertThatThrownBy(() -> new Product(null, new Name("상품"), null, new Price(BigDecimal.valueOf(1000))))
                .isInstanceOf(IllegalArgumentException.class)
