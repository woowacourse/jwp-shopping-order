...
class DiscountCalculatorTest {
    ...
    void calculatePriceAfterDiscount(String testName, Integer originPrice, Optional<Coupon> coupon, Integer expectedValue) {
    ...
    private static Stream<Arguments> validateDiscountCalculator() {
        return Stream.of(
                Arguments.of("정액 할인 쿠폰", 10000, Optional.of(COUPON_1_NOT_NULL_PRICE), 5000),
                Arguments.of("할인율 쿠폰", 10000, Optional.of(COUPON_2_NOT_NULL_RATE), 9000),
                Arguments.of("할인율 쿠폰", 10000, Optional.ofNullable(COUPON_3_NULL), 10000)
        );
    }
