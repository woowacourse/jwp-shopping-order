...
public class Fixture {
    ...
    public static Coupon coupon1 = new Coupon(1L, "30000원 이상 3000원 할인 쿠폰", new PricePolicy(), BigDecimal.valueOf(3000L), new Money(30000L));
    public static Coupon coupon2 = new Coupon(2L, "50000원 이상 5000원 할인 쿠폰", new PricePolicy(), BigDecimal.valueOf(5000L), new Money(50000L));
