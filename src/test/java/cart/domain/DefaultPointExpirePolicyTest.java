...
class DefaultPointExpirePolicyTest {
    ...
    void calculateExpireDate(@JavaTimeConversionPattern("yyyy.MM.dd")LocalDate now,
        ...
        DefaultPointExpirePolicy defaultPointExpirePolicy = new DefaultPointExpirePolicy();

        assertThat(defaultPointExpirePolicy.calculateExpireDate(now)).isEqualTo(expected);
    }
}
