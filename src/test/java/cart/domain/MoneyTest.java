...
public class MoneyTest {
    ...
    void 돈을_더한다() {
        // given
        final Money money1 = new Money(1000L);
        final Money money2 = new Money(2000L);
    ...
    void 백분율을_구한다() {
        // given
        final Money money = new Money(2000L);

        // when
        final Money result = money.percent(10);

        // then
        assertThat(result.getValue()).isEqualTo(200L);
    }
    ...
    void 돈의_값이_이상인지_확인한다() {
        ...
        // when
        final boolean result1 = money.isMoreThan(new Money(2000L));
        final boolean result2 = money.isMoreThan(new Money(2001L));
