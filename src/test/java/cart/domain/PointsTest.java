...
class PointsTest {
    ...
    @Test
    void getUsablePoints_success_1() {
        ...
        Points usablePoints = points.getUsablePoints(Point.from(3700));
    ...
    @Test
    void getUsablePoints_success_2() {
        Points points = new Points(List.of(
                Point.of(1L, 1000, "테스트", LocalDate.of(2023, 3, 5), LocalDate.of(2023, 6, 30)),
                Point.of(2L, 2000, "테스트", LocalDate.of(2023, 5, 5), LocalDate.of(2023, 8, 31)),
                Point.of(3L, 3000, "테스트", LocalDate.of(2023, 2, 5), LocalDate.of(2023, 5, 31))
        ...
        Points usablePoints = points.getUsablePoints(Point.from(4000));
    ...
    void getUsablePoints_fail() {
        ...
        assertThatThrownBy(() -> points.getUsablePoints(Point.from(50000)))
                .isInstanceOf(OrderException.class)
                .hasMessageContaining("사용할 수 있는 포인트보다 더 많은 포인트를 사용했습니다.");
    }
}
