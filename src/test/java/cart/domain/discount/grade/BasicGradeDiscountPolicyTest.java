...
class BasicGradeDiscountPolicyTest {
    ...
    public static Stream<Arguments> provideParamsAndExpected() {
        return Stream.of(
                Arguments.of(20000, Grade.FIVE_PERCENT_DISCOUNT_GRADE, new DiscountInformation("memberGradeDiscount", 0.05, 1000)),
                Arguments.of(20000, Grade.THREE_PERCENT_DISCOUNT_GRADE, new DiscountInformation("memberGradeDiscount", 0.03, 600)),
                Arguments.of(20000, Grade.ONE_PERCENT_DISOCUNT_GRADE, new DiscountInformation("memberGradeDiscount", 0.01, 200)),
                Arguments.of(100000, Grade.FIVE_PERCENT_DISCOUNT_GRADE, new DiscountInformation("memberGradeDiscount", 0.05, 5000))
        );
    }
}
