...
class OrderItemEntityTest {
    ...
    void ID가_같으면_같은_객체이다() {
        OrderItemEntity orderItemEntity = new OrderItemEntity(1L, 30L, "name", 1_000, "image", 10);
        OrderItemEntity same = new OrderItemEntity(1L, 30L, "name", 1_000, "image", 10);
        OrderItemEntity different = new OrderItemEntity(2L, 30L, "name", 1_000, "image", 10);
