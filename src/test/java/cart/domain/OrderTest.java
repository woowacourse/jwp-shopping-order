...
class OrderTest {
    ...
    @Test
    void generate() {
        final Order actual = Order.generate(Fixture.memberA, 0, List.of(Fixture.cartItem1));
    ...
    void generatePointFail() {
        assertThatThrownBy(() -> Order.generate(Fixture.memberA, 9999, List.of(Fixture.cartItem1)))
    ...
    void generateCartItemSizeFail() {
        assertThatThrownBy(() -> Order.generate(Fixture.memberA, 0, List.of()))
                .isInstanceOf(IllegalArgumentException.class);
    }
}
