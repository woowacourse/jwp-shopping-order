...
class CartItemDaoTest {
    ...
    void 장바구니에_상품을_추가한다() {
        ...
        final ProductEntity product = productDao.insert(new ProductEntity("치즈피자1", "1.jpg", BigDecimal.valueOf(8900L)));
    ...
    void 사용자_아이디를_받아_해당_사용자의_장바구니에_있는_모든_품목을_반환한다() {
        ...
        final ProductEntity product1 = productDao.insert(new ProductEntity("치즈피자1", "1.jpg", BigDecimal.valueOf(8900L)));
        final ProductEntity product2 = productDao.insert(new ProductEntity("치즈피자2", "2.jpg", BigDecimal.valueOf(8900L)));
        final ProductEntity product3 = productDao.insert(new ProductEntity("치즈피자3", "3.jpg", BigDecimal.valueOf(8900L)));
