...
class ProductDaoTest {
    ...
    void 상품을_저장한다() {
        // given
        final ProductEntity product = new ProductEntity("허브티", "tea.jpg", BigDecimal.valueOf(1000L));
    ...
    void 전체_상품을_조회한다() {
        // given
        final ProductEntity product1 = new ProductEntity("허브티", "tea.jpg", BigDecimal.valueOf(1000L));
        final ProductEntity product2 = new ProductEntity("고양이", "cat.jpg", BigDecimal.valueOf(1000000L));
    ...
    void 상품을_수정한다() {
        ...
        final ProductEntity product = new ProductEntity("허브티", "tea.jpg", BigDecimal.valueOf(1000L));
        final ProductEntity savedProduct = productDao.insert(product);
        final ProductEntity updatedProduct = new ProductEntity(savedProduct.getId(), "블랙캣", "cat.jpg", BigDecimal.valueOf(10000L));
        ...
        assertAll(
                ...
                () -> assertThat(result.getPrice().longValue()).isEqualTo(10000L)
        );
    }
    ...
    void 입력받은_아이디에_대한_상품을_조회한다() {
        ...
        final ProductEntity product1 = new ProductEntity("허브티", "tea.jpg", BigDecimal.valueOf(1000L));
        final ProductEntity product2 = new ProductEntity("고양이", "cat.jpg", BigDecimal.valueOf(1000000L));
        final ProductEntity product3 = new ProductEntity("스프라이트", "sprite.jpg", BigDecimal.valueOf(1000000L));
        final ProductEntity savedProduct1 = productDao.insert(product1);
        final ProductEntity savedProduct2 = productDao.insert(product2);
