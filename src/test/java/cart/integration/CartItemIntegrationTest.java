...
public class CartItemIntegrationTest extends IntegrationTest {
    ...
    @BeforeEach
    void init() {
        밀리 = new Member("millie@email.com");
        박스터 = new Member("boxster@email.com");
        인증용_밀리 = memberRepository.save(new AuthMember(밀리, "millie"));
        인증용_박스터 = memberRepository.save(new AuthMember(박스터, "boxster"));
        ...
        잘못된_사용자 = new AuthMember(밀리, 인증용_밀리.getPassword() + "asdf");
    }
    ...
    class 장바구니에_상품을_등록할_때 {
        ...
        @Test
        void 정상_추가한다() {
            var 응답 = 장바구니에_상품_등록_요청(인증용_밀리, 상품_치킨.getId());
    ...
    class 장바구니에서_상품을_전체_조회할_때 {
        ...
        @Test
        void 정상_전체_조회한다() {
            Long firstSaveID = 아이디를_반환한다(장바구니에_상품_등록_요청(인증용_밀리, 상품_치킨.getId()));
            Long secondSaveID = 아이디를_반환한다(장바구니에_상품_등록_요청(인증용_밀리, 상품_피자.getId()));

            var 응답 = 장바구니_상품_전체_조회_요청(인증용_밀리);
    ...
    class 장바구니의_상품_수량을_수정할_때 {
        ...
        @Test
        void 정상_수정한다() {
            Long 장바구니_ID = 아이디를_반환한다(장바구니에_상품_등록_요청(인증용_밀리, 상품_치킨.getId()));

            var 응답 = 장바구니_상품_수량_수정_요청(인증용_밀리, 장바구니_ID, 10);

            응답_코드_검증(응답, HttpStatus.OK);
            장바구니_전체_조회_응답_검증(장바구니_상품_전체_조회_요청(인증용_밀리), 장바구니_응답(장바구니_ID, 상품_치킨, 10));
        }
        ...
        void 다른_사용자의_장바구니의_수량을_수정_요청시_실패한다() {
            ...
            var 응답 = 장바구니_상품_수량_수정_요청(인증용_박스터, 장바구니_ID, 10);
        ...
        void 장바구니의_수량을_0으로_수정_요청시_장바구니를_삭제한다() {
            ...
            var 응답 = 장바구니_상품_수량_수정_요청(인증용_밀리, 장바구니_ID, 0);

            응답_코드_검증(응답, HttpStatus.OK);
            장바구니_전체_조회_응답_검증(장바구니_상품_전체_조회_요청(인증용_밀리));
        }
    }
    ...
    class 장바구니를_삭제_요청할_때 {
        ...
        void 정상_삭제한다() {
            ...
            var 응답 = 장바구니_삭제_요청(인증용_밀리, 장바구니_ID);
        ...
        void 다른_사용자의_장바구니_삭제_요청시_실패한다() {
            ...
            var 응답 = 장바구니_삭제_요청(인증용_박스터, 장바구니_ID);
