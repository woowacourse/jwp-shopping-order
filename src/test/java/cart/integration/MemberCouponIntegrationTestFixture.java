...
public class MemberCouponIntegrationTestFixture {
    ...
    public static CouponsResponse 쿠폰_전체_조회_응답(List<RateCouponResponse> 정률_쿠폰들, List<FixedCouponResponse> 정액_쿠폰들) {
        return new CouponsResponse(정률_쿠폰들, 정액_쿠폰들);
    }

    public static void 쿠폰_전체_조회_응답_검증(ExtractableResponse<Response> 응답, CouponsResponse couponResponse) {
        assertThat(응답.as(CouponsResponse.class)).usingRecursiveComparison()
