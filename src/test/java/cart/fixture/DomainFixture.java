...
public class DomainFixture {
    ...
    public static final Member MEMBER_A = new Member(1L, "a@a.com", "1234", 3_500);
    public static final Member MEMBER_B = new Member(2L, "b@b.com", "1234", 3_500);
    ...
    public static final CartItem FOUR_SALAD = new CartItem(2L, 4, MEMBER_A, SALAD);
}
