...
public class OrderDaoFixture {
    ...
    public Long 주문을_등록한다(Member 회원, CartItems 장바구니_상품_목록, String 사용한_포인트, LocalDateTime 주문_시간) {
        return orderDao.insertOrder(주문_엔티티(회원.getId(), 장바구니_상품_목록.totalPrice().getValue().toString(), 사용한_포인트, 주문_시간));
    }
