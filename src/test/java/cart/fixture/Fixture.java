...
import cart.domain.coupon.PriceStrategy;
...
public class Fixture {
    ...
    public static final Coupon 쿠폰 = new Coupon(1L, "오픈 기념 쿠폰", new Discount(new RateStrategy(), 10));
    public static final MemberCoupon 멤버_쿠폰 = new MemberCoupon(1L, new Coupon(1L, "오픈 기념 쿠폰", new Discount(new RateStrategy(), 10)), false);
    public static final MemberCoupon 멤버_쿠폰2 = new MemberCoupon(2L, new Coupon(2L, "오픈 기념 쿠폰", new Discount(new PriceStrategy(), 2000)), false);
