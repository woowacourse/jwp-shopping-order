...
class CartItemDaoTest {
    ...
    class 카트_아이템_저장이_필요하지_않은_테스트 {
        ...
        void 카트_아이템_추가_테스트() {
            // given
            long cartItemId = cartItemDao.save(new CartItem(member, product));
    ...
    class 카트_아이템_저장이_필요한_테스트 {
        ...
        void 카트_전부_제거_테스트() {
            // given
            long cartItemId = cartItemDao.save(new CartItem(member, product));
            long cartItemId2 = cartItemDao.save(new CartItem(member, product));
            long cartItemId3 = cartItemDao.save(new CartItem(member, product));
