...
class DiscountConditionTest {
    ...
    void 언제나_할인하지_않는_할인조건() {
        // given
        DiscountCondition discountCondition = DiscountCondition.NoneDiscountCondition;
    ...
    void 언제나_할인_조건을_만족한다() {
        // given
        DiscountCondition discountCondition = DiscountCondition.AlwaysDiscountCondition;
