...
ALTER TABLE order_info ALTER COLUMN id RESTART WITH 1;
...
INSERT INTO product (name, price, image_url, point_ratio, point_available)
SELECT '샐러드', 20000, 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2370&q=80', 10.0, false FROM DUAL
WHERE NOT EXISTS (SELECT * FROM product WHERE name = '샐러드' AND price = 20000 AND image_url = 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2370&q=80' AND point_ratio = 10.0 AND point_available = false);
