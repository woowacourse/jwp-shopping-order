...
INSERT INTO coupon (id, name, discount_type, discount_percent, discount_amount, minimum_price)
VALUES (1, '1000원 할인 쿠폰', 'deduction', 0.0, 1000, 0);
INSERT INTO coupon (id, name, discount_type, discount_percent, discount_amount, minimum_price)
VALUES (2, '10% 할인 쿠폰', 'percentage', 0.1, 0, 0);
