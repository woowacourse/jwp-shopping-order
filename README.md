...
- [ ] 상품 수정을 할 수 있다.
  ...
  - 수정할 상품 ID와 상품 정보를 담아서 요청한다.
    - 수정할 상품 ID가 존재하지 않으면 예외가 발생한다.
    - 수정할 상품 ID가 존재하면 상품 정보를 수정할 수 있다.
...
- [ ] 상품 목록 조회를 할 수 있다.
    - 관리자가 아니면 예외가 발생한다.
    - 장바구니에 담긴 상품이면 장바구니 수량 수정 버튼이 표시된다.
    - 장바구니에 담기지 않은 상품이면 장바구니 상품 추가 버튼이 표시된다.

<br>

- [ ] 상품 상세 조회를 할 수 있다.
    - 인증된 사용자가 아니면 예외가 발생한다.
    - 조회할 상품 ID가 존재하지 않으면 예외가 발생한다. 
    - 조회할 상품 ID가 존재한다면 상세 조회가 된다.
...
- [ ] 장바구니의 상품 수량을 수정할 수 있다.
  ...
  - 수량을 수정할 상품 ID와 수정할 수량을 담아서 요청한다.
    - 수량을 수정할 상품 ID가 존재하지 않으면 예외가 발생한다.
...
- [ ] 장바구니에 담긴 상품을 삭제할 수 있다.
  ...
  - 삭제할 장바구니에 담긴 상품 ID를 담아서 요청한다.
    - 장바구니에 담긴 상품 ID가 존재하지 않으면 예외가 발생한다.
